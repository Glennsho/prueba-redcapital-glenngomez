    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.files.store', $archivo) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="users" class="col-md-2 col-form-label text-md-right">{{ __('Usuarios') }}</label>
                            <div class="col-md-6">
